...
var _voteRanked = __webpack_require__(5);
...
window.onload = function () {
    ...
    if (getParameterByName('login')) {
        var modal = new Foundation.Reveal((0, _jquery2.default)('#loginModal'));
        modal.open();
    };
};
...
var _Sortable = __webpack_require__(6);

var _Sortable2 = _interopRequireDefault(_Sortable);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports.voteRanked = function () {
    ...
    $('.ranked-ballot-submit').click(function (e) {
        if (!$('.ranked-ballot-submit').hasClass('disabled')) {
            var choices = $('.rankedBallotSort li').map(function () {
                return $(this).text();
            }).toArray();
            $.post('/vote/ranked', { id: $('.rankedBallotSort').data('ballot-id'), choices: choices }).done(function (resp) {
                alert(resp);
            });
